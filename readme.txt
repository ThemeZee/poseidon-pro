=== Poseidon Pro ===
Plugin URL: https://themezee.com/addons/poseidon-pro/
...
Adds additional features and customization options to the Poseidon theme.

== Description ==

The *Poseidon Pro* plugin adds additional features to the Poseidon theme.
...
1. Install the Poseidon Pro Plugin on Plugins -> Add New -> Upload Plugin by uploading the .ZIP plugin file.
...
Please see our [Poseidon Theme Documentation](https://themezee.com/docs/poseidon-documentation/ "Poseidon Theme Documentation").
