...
class Poseidon_Pro_Widget_Areas {
	...
	static function setup() {
		...
		add_action( 'poseidon_before_footer', array( __CLASS__, 'display_before_footer_columns' ), 10 );
		add_action( 'poseidon_before_footer', array( __CLASS__, 'display_before_footer_copyright' ), 30 );
	}
	...
	static function register_widgets() {
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Before Footer Columns', 'poseidon-pro' ),
			'id'            => 'before-footer-columns',
			'description'   => esc_html_x( 'Appears above the footer columns area.', 'widget area description', 'poseidon-pro' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
		...
		register_sidebar( array(
			'name'          => esc_html__( 'Before Footer Copyright', 'poseidon-pro' ),
			'id'            => 'before-footer',
			'description'   => esc_html_x( 'Appears above the footer copyright area.', 'widget area description', 'poseidon-pro' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
