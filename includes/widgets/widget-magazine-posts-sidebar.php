...
class Poseidon_Pro_Magazine_Posts_Sidebar_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'widget_poseidon_magazine_posts_sidebar', 'widget' );
		}
		if ( ! is_array( $cache ) ) {
			$cache = array();
		}
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'widget_poseidon_magazine_posts_sidebar', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
...
<?php
	...
	public function delete_widget_cache() {
		...
		wp_cache_delete( 'widget_poseidon_magazine_posts_sidebar', 'widget' );
